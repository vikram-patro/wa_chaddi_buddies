...
st.markdown("""
The legendary schoolmates group was created by our legendary <a href="https://wa.me/919985646612" style="color:steelblue" target="_blank">**Chaten**</a> on 28-Nov-2013 around 9 PM IST and as they popularly say the rest is history.
...
st.markdown("<i>Date and time are in IST<br>Data extracted on 2023-Jun-04</i>", unsafe_allow_html=True)
